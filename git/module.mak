...
$(BUILD)/.gitconfig: git/gitconfig config/git_config_db.json git/module.mak | $(BUILD)
	@#echo "- Creating $@"
...
$(BUILD)/.global_gitignore: $(wildcard git/gitignore/Global/*.gitignore) git/module.mak | $(BUILD)
	@#echo "- Creating $@"
	@cat git/gitignore/Global/*.gitignore > $(BUILD)/.global_gitignore

$(BUILD)/.gitattributes: git/gitattributes git/module.mak | $(BUILD)
	@#echo "- Creating $@"
