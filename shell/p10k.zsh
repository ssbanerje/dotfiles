...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VICMD,VIVIS,VIOWR}_FOREGROUND=46
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIVIS,VIOWR}_FOREGROUND=11
  ...
  typeset -g POWERLEVEL9K_RANGER_VISUAL_IDENTIFIER_EXPANSION='פּ'

  # Vim shell
  typeset -g POWERLEVEL9K_VIM_SHELL_FOREGROUND=46

  # Disk usage
  typeset -g POWERLEVEL9K_DISK_USAGE_NORMAL_FOREGROUND=67
  ...
  # RAM
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=67

  # Swap
  typeset -g POWERLEVEL9K_SWAP_FOREGROUND=67

  # Load
  typeset -g POWERLEVEL9K_LOAD_WHICH=5
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=67
